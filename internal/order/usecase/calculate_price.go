...
import "aceleracao/golang/internal/order/entity"
...
func NewCalculatePriceUseCase(orderRepository entity.OrderRepositoryInterface) *CalculateFinalPriceUseCase {
